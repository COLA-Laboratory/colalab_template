...
% ── Footer: page x/xx on all pages; first page also shows title + date ──────
\newcommand{\PageCounterText}{%
  {\small\color{headerblue}\faBookOpen~~\textbf{\thepage}/\pageref{LastPage}}%
}
\newcommand{\FirstPageFooterLeft}{%
  \small{\color{headerblue}\faIcon[regular]{book}}~~%
  {\small\color{headerblue}\textbf{\ReportTitleMarkText\ | \today}}%
}
\fancypagestyle{allpagesfooter}{%
  \fancyhf{}%
  \renewcommand{\headrulewidth}{0pt}%
  \renewcommand{\footrulewidth}{0pt}%
  \fancyfoot[R]{\PageCounterText}%
}
\fancypagestyle{firstpagefooter}{%
  \fancyhf{}%
  \renewcommand{\headrulewidth}{0pt}%
  \renewcommand{\footrulewidth}{0pt}%
  \fancyfoot[L]{\FirstPageFooterLeft}%
  \fancyfoot[R]{\PageCounterText}%
}
\pagestyle{allpagesfooter}
